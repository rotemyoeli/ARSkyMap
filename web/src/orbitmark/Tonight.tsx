...
/**
 * Shape-first marker glyph (colour only reinforces) with the signature uncertainty ring.
 * The ring GROWS and FADES with `uncertainty` (0..1, from TLE age) — graded, not a hard edge —
 * so older elements read as less certain (grounded in SGP4 age-error + uncertainty-viz research).
 */
